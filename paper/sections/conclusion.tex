...
We provide an evidence package spanning standard constrained benchmarks (fixed 30-seed protocols) and governance stress tests (matched 50-seed comparisons), alongside calibration diagnostics, perturbation analyses, and cost appendices. Regeneration scripts and artifacts are available upon request.